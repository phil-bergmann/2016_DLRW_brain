...
In the first step the absolute values of the input data are calculated. Then they are normalized to zero mean and scaled to fit into the interval $\left[-1,1\right]$.
...
In the neuronal network implementation, error back-propagation should be performed after 300 data samples.
...
Figure \ref{fig:emg_RNN_1} shows the results of a RNN trained with six data series of participant 1.
