...
For implementation of a recurrent neural network Python \cite{python} and the library Theano \cite{theano} with extension of Climin \cite{climin} for the networks parameter weight initialization by random uniform distribution was used. Furthermore implementations of various RNNs is provided by Breze \cite{breze} and used to extend the initial from scratch attempt.
