...
%GAL: Grasp And Lift\\
Experiment recording human grasp and lift tasks\footnote{Data source: Umea University, Schweden\cite{eeg-emg-dataset}}%\footnote{Data source: Luciw, M. D., Jarocka, E. \& Edin, B. B. FigShare http://dx.doi.org/10.6084/m9.figshare.988376 (2014).}
...
%\begin{figure}[ht]
%    \centering
%    \includegraphics[scale=0.2]{images/eegelectrodes.png}
%\end{figure}
...
%predictability in human planning infers $\rightarrow$ history matters
%\end{block}
...
%        \newblock \emph{Journal Name} 12(3), 45 -- 678.
        ...
        \bibitem[EEG-data, 2014]{eeg-emg-dataset} Luciw, M. D., Jarocka, E. \& Edin, B. B.  (2014)
        \newblock WAY-EEG-GAL data set
        \newblock \emph FigShare http://dx.doi.org/10.6084/m9.figshare.988376
