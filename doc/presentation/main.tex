...
\medskip
\textit{roman podolski@tum.de, philipp.bergmann@tum.de, dominik.irimi@gmail.com, manuel.nickel@tum.de, dehner@in.tum.de} % Your email address
}
...
\begin{itemize}
	...
	\item Measurement of EEG and EMG data
\end{itemize}
\end{frame}
...
\begin{itemize}
	\item Normalization
	\item Subsampling of EMG data
\end{itemize}
\item t-SNE
\item RNN
\begin{itemize}
\item Network shape
\item Data input shape
