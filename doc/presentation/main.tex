...
\begin{frame}{Methodology RNN}
        ...
        \only<4>{
                ...
                \begin{itemize}
                    \item Network design:
                    \begin{itemize}
                        \item 100 tanh activated neurons in 1 hidden layer
                        \item sigmoid shaped output layer neurons
                        \item 100/200 tanh neurons
                        \item 1 hidden layer
                        \item 50 samples per batch
                        \item optimizer: Adadelta, \(RmsProp\)
                    \end{itemize}
                    \item Weight initialization by random uniform distribution
