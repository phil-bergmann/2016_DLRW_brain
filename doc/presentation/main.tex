...
\begin{itemize}
    ...
    \item Separation into sets of 300 data point records length
   	...
   	\item Cross validation split: train/valid/test $\rightarrow$ 0.8/0.1/0.1
\end{itemize}
\end{frame}
...
\begin{frame}
	...
	Training with data of one participant:
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\textwidth,clip]{images/EMG-results_participant_1_series1-6.png}
...
\begin{frame}
	\frametitle{Results (2): RNN on EMG data}
	Training with data of more than one participant:
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1.0\textwidth,clip]{images/EMG-results_participant_1-2_series1-3.png}
